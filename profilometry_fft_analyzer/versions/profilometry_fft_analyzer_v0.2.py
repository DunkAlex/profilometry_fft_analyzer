...
def compute_rz(roughness, dx, sampling_length_um):
    ...
    physical sampling length along x (ISO convention, typically 5 chunks
    averaged). `sampling_length_um` is named for historical reasons - the
    value should be in the same x-axis units as dx.
